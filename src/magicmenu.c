...
--*/
{
   ...
   BYTE        bColor;
   const int   iItemsPerLine = 32 / gWordLength;
   const int   iItemTextWidth = 8 * gWordLength + 7;
   const int   iLinesPerPage = 5 - gScreenLayout.ExtraMagicDescLines;
   const int   iBoxYOffset = gScreenLayout.ExtraMagicDescLines * 16;
